...
import { runModel } from '../models/stockAndFlowModel.js';
import fs from 'fs';

// Disease parameters from CSV
const diseaseBaseParams = {
  tuberculosis: {
    name: 'Tuberculosis',
    lambda: 0.002,
...
function analyzeScenario(countryCode, isUrban, disease) {
...
fs.writeFileSync('country_scenario_analysis_report.md', report);

// Also save raw results as JSON
fs.writeFileSync('country_scenario_analysis_results.json', JSON.stringify(results, null, 2));

console.log('Analysis complete. Results saved to:');
console.log('- country_scenario_analysis_report.md');
console.log('- country_scenario_analysis_results.json');