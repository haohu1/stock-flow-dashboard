...
import { countryProfiles, countryDiseaseBurdens } from '../models/countrySpecificModel';
...
for (const country of countries) {
  ...
  const burdens = countryDiseaseBurdens[country];
  ...
  let chwBonus = 0;
  if (country === 'kenya') chwBonus = 0.15;
  else if (country === 'south_africa') chwBonus = 0.10;
  else if (country === 'nigeria') chwBonus = 0.05;
